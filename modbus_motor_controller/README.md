...
This project is based on Modbus Slave Example and it mocks a motor controller.
The goal is to use this on a ESP target that is connected to a RS-485 bus and it mocks a motor controller,
which can be accessed and controlled from any master on the bus.
